...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    // Also listen for context loss on the canvas itself
    ...
    dpr, paused, colors, backgroundColor, speed, streakCount,
    streakWidth, streakLength, glow, density, twinkle, zoom,
    backgroundGlow, opacity, mouseInteraction, mouseStrength,
